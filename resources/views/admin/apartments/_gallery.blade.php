...
@php
    $images = $apartment->relationLoaded('images') ? $apartment->images : $apartment->images()->orderBy('sort_order')->get();
...
<div class="mt-12 max-w-5xl border-t border-stone-200 pt-10">
    ...
    <p class="mt-1 text-sm text-stone-500">{{ __('Upload as many photos as you need. Reorder with the arrows, edit alt text, replace a file, or remove a photo.') }}</p>
