...
<footer class="relative border-t border-stone-200/90 bg-white text-stone-700">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="grid gap-12 sm:gap-14 lg:grid-cols-12 lg:gap-12">
            ...
            {{-- Contact --}}
            <div class="lg:col-span-5 lg:border-l lg:border-stone-200 lg:pl-10">
                <p class="text-[11px] font-semibold uppercase tracking-[0.22em] text-gold-600">{{ __('Contact') }}</p>
            ...
            {{-- Explore --}}
            <div class="lg:col-span-3 lg:border-l lg:border-stone-200 lg:pl-10">
                <p class="text-[11px] font-semibold uppercase tracking-[0.22em] text-gold-600">{{ __('Explore') }}</p>
